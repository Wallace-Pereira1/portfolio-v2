          ...
          >
            ...
            <div className="flex items-start justify-between gap-6">
              ...
              <button
                type="button"
                onClick={onClose}
                className="inline-flex flex-shrink-0 items-center gap-2 rounded-full border border-transparent bg-white/5 px-4 py-2 text-sm font-semibold text-primary transition-all hover:bg-white/10 hover:border-white/10"
              >
            ...
            <p className="mt-6 text-primary/85 leading-relaxed">
              {project.descriptionLong}
            </p>

            <div className="mt-8">
              <p className="text-xs font-extrabold tracking-[0.22em] uppercase text-secondary">
                Tech Stack
              </p>
              <div className="mt-3 flex flex-wrap gap-2">
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="rounded-full border border-transparent bg-white/5 px-3 py-1 text-xs font-semibold text-primary"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {project.links.github && (
                <a
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-transparent bg-white/5 px-5 py-3 text-sm font-semibold text-primary transition-all hover:bg-white/10 hover:border-white/10"
